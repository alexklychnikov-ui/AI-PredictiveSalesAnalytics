...
PATH_STEPS = [
    ("Загрузка", "CSV/XLSX или синтетика → сохранить в PostgreSQL"),
    ("Аналитика", "KPI, тренд, сезонность, аномалии"),
    ("Прогноз", "Prophet vs baseline + backtesting"),
    ("Сценарии", "Stress-test и what-if по eligible факторам"),
    ("Рекомендации", "Rules + опционально OpenAI по facts"),
]
